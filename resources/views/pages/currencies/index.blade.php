            ...
            <tbody>
                @forelse ($currencies as $currency)
                    <tr>
                        ...
                        <td class="py-2 px-4 text-sm text-gray-700">{{ $currency->name }}</td>
                        <td class="py-2 px-4 text-sm text-gray-700">{{ $currency->code }}</td>
                        <td class="py-2 px-4 text-sm text-gray-700">{{ $currency->created_at }}</td>
                        
                        <td class="py-2 px-4 text-sm text-gray-700 flex gap-1">
                            <button id="editBtn" class="bg-blue-500 text-white px-2 py-1 rounded-md hover:bg-blue-600 transition duration-150 ease-in-out shadow-md hover:shadow-lg editBtn" data-id="{{ $currency->id }}" data-name="{{ $currency->name }}">
                                Update
                            </button>
